...
# changing the logo
logo = pygame.image.load('Car_Race/car_assets_game/Logo_1.jfif')
...
def introImg(x, y):
    intro = pygame.image.load("Car_Race/car_assets_game/intro-2.jpg")

    screen.blit(intro, (x, y))


def instructionIMG(x, y):
    instruct = pygame.image.load("Car_Race/car_assets_game/instruction-1.jpg")
    run = True
    while run:
...
def aboutIMG(x, y):
    aboutimg = pygame.image.load("Car_Race/car_assets_game/About-1.jpg")
    run = True
    while run:
...
def introscreen():
    run = True
    pygame.mixer.music.load('Car_Race/car_assets_game/startingMusic.mp3')
...
def countdown():
    ...
    countdownBacground = pygame.image.load('Car_Race/car_assets_game/bg.png')
...
def gameloop():
    ####### music #######
    pygame.mixer.music.load('Car_Race/car_assets_game/BackgroundMusic.mp3')
    pygame.mixer.music.play()
    ###### sound effect for collision ######
    crash_sound = pygame.mixer.Sound('Car_Race/car_assets_game/car_crash.wav')
    ...
    # highscore part
    with open("Car_Race/car_assets_game/highscore.txt", "r") as f:
        highscore = f.read()
    ...
    def gameover():
        gameoverImg = pygame.image.load("Car_Race/car_assets_game/game-over.jpg")
        run = True
        while run:
    ...
    bg = pygame.image.load('Car_Race/car_assets_game/bg.png')

    # setting our player
    maincar = pygame.image.load('Car_Race/car_assets_game/car.png')
    maincarX = 350
    maincarY = 495
    maincarX_change = 0
    maincarY_change = 0
    ...
    while run:
        ...
        with open("Car_Race/car_assets_game/highscore.txt", "w") as f:
